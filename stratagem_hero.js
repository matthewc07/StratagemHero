...
function startGame() {
    ...
    function print_white_arrows(combo) {
        ...
        for (let c = 0; c < combo.length; c++) {
            ...
            if (combo[c] == 1) {
                arrowicon = new Images("./MEDIA/upwhite.png", arrowXPos, arrowYPos, 60, 60);
            }
            if (combo[c] == 2) {
                arrowicon = new Images("./MEDIA/rightwhite.png", arrowXPos, arrowYPos, 60, 60);
            }
            if (combo[c] == 3) {
                arrowicon = new Images("./MEDIA/downwhite.png", arrowXPos, arrowYPos, 60, 60);
            }
            if (combo[c] == 4) {
                arrowicon = new Images("./MEDIA/leftwhite.png", arrowXPos, arrowYPos, 60, 60);
            }
    ...
    let icon = new Images("./MEDIA/icons/coconut.webp", WIDTH * .35, HEIGHT * .14, WIDTH * .30, HEIGHT * .40);
    icon.draw(ctx);
    ...
    function generateRandomCombo() {
        ...
        if (rng == 1) {
            ...
            icons("./MEDIA/icons/Machine_Gun.webp");
        }
        ...
        if (rng == 2) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Anti-Material_Rifle.webp");
        }
        ...
        if (rng == 3) {
            ...
            print_name("Stalwart");
            print_white_arrows(combo);
            icons("./MEDIA/icons/Stalwart.webp");
        }
        ...
        if (rng == 4) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Expendable_Anti-tank.webp");
        }
        ...
        if (rng == 5) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Recoilless_Rifle.webp");
        }
        ...
        if (rng == 6) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Flamethrower.webp");
        }
        ...
        if (rng == 7) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Autocannon.webp");
        }
        ...
        if (rng == 8) {
            ...
            print_name("Railgun");
            print_white_arrows(combo);
            icons("./MEDIA/icons/Railgun.webp");
        }
        ...
        if (rng == 9) {
            ...
            print_name("Spear");
            print_white_arrows(combo);
            icons("./MEDIA/icons/SPEAR_Launcher.webp");
        }
        ...
        if (rng == 10) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Orbital_Gatling_Barrage.webp");
        }
        ...
        if (rng == 11) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Orbital_Airbust_Strike.webp");
        }
        ...
        if (rng == 12) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Orbital_120MM_HE_Barrage.webp");
        }
        ...
        if (rng == 13) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Orbital_380MM_HE_Barrage.webp");
        }
        ...
        if (rng == 14) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Orbital_Walking_Barrage.webp");
        }
        ...
        if (rng == 15) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Orbital_Laser.webp");
        }
        ...
        if (rng == 16) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Orbital_Railcannon_Strike.webp");
        }
        ...
        if (rng == 17) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Eagle_Strafing_Run.webp");
        }
        ...
        if (rng == 18) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Eagle_Airstrike.webp");
        }
        ...
        if (rng == 19) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Eagle_Cluster_Bomb.webp");
        }
        ...
        if (rng == 20) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Eagle_Napalm.webp");
        }
        ...
        if (rng == 21) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Jump_Pack.webp");
        }
        ...
        if (rng == 22) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Eagle_Smoke.webp");
        }
        ...
        if (rng == 23) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Eagle_110MM_Rocket_Pods.webp");
        }
        ...
        if (rng == 24) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Eagle_500kg_Bomb.webp");
        }
        ...
        if (rng == 25) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Orbital_Precision_Strike.webp");
        }
        ...
        if (rng == 26) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Orbital_Gas_Strike.webp");
        }
        ...
        if (rng == 27) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Orbital_EMS_Strike.webp");
        }
        ...
        if (rng == 28) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Orbital_Smoke_Strike.webp");
        }
        ...
        if (rng == 29) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/HMG_Emplacement.webp");
        }
        ...
        if (rng == 30) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Shield_Generator_Relay.webp");
        }
        ...
        if (rng == 31) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Tesla_Tower.webp");
        }
        ...
        if (rng == 32) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Anti-Personnel_Minefield.webp");
        }
        ...
        if (rng == 33) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Supply_Pack.webp");
        }
        ...
        if (rng == 34) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Grenade_Launcher.webp");
        }
        ...
        if (rng == 35) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Laser_Cannon.webp");
        }
        ...
        if (rng == 36) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Incendiary_Mines.webp");
        }
        ...
        if (rng == 37) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Guard_Dog_Rover.webp");
        }
        ...
        if (rng == 38) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Ballistic_Shield_Backpack.webp");
        }
        ...
        if (rng == 39) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Arc_Thrower.webp");
        }
        ...
        if (rng == 40) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Shield_Generator_Pack.webp");
        }
        ...
        if (rng == 41) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Machine_Gun_Sentry.webp");
        }
        ...
        if (rng == 42) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Gatling_Sentry.webp");
        }
        ...
        if (rng == 43) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Mortar_Sentry.webp");
        }
        ...
        if (rng == 44) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Guard_Dog.webp");
        }
        ...
        if (rng == 45) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Autocannon_Sentry.webp");
        }
        ...
        if (rng == 46) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Rocket_Sentry.webp");
        }
        ...
        if (rng == 47) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/EMS_Mortar.webp");
        }
        ...
        if (rng == 48) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Reinforce.webp");
        }
        ...
        if (rng == 49) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/SOS_Beacon.webp");
        }
        ...
        if (rng == 50) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Super_Earth_Flag.jpg");
        }
        ...
        if (rng == 51) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/DeliverSSSD.webp");
        }
        ...
        if (rng == 52) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Hellbomb.webp");
        }
        ...
        if (rng == 53) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Eagle_Rearm.webp");
        }
        ...
        if (rng == 54) {
            ...
            print_white_arrows(combo);
            icons("./MEDIA/icons/Patriot_Exosuit.webp");
        }
        return combo;
    }
        ...
        if (correct) {
            ...
            for (let c = 0; c < combo.length; c++) {
                ...
                if (player_guess[c] == combo[c]) {
                    if (combo[c] == 1) {
                        arrowicon = new Images("./MEDIA/upgreen.png", arrowXPos, arrowYPos, 60, 60);
                    }
                    if (combo[c] == 2) {
                        arrowicon = new Images("./MEDIA/rightgreen.png", arrowXPos, arrowYPos, 60, 60);
                    }
                    if (combo[c] == 3) {
                        arrowicon = new Images("./MEDIA/downgreen.png", arrowXPos, arrowYPos, 60, 60);
                    }
                    if (combo[c] == 4) {
                        arrowicon = new Images("./MEDIA/leftgreen.png", arrowXPos, arrowYPos, 60, 60);
                    }
